...
<template layout>
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div
                class="flex justify-center items-center pt-8 space-x-12 sm:pt-0">
                <LaravelLogo class="h-20 w-auto text-[#EF3B2D]" />
                <InertiaLogo class="h-11 w-auto text-[#826ded]" />
            </div>

            <div
                class="mt-8 bg-white dark:bg-zinc-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <ResourceBlock name="Documentation"
                    ...
                    <ResourceBlock
                        ...
                        libraries, such as <a href="https://forge.laravel.com"
                            ...
                            class="underline">Envoyer</a> help you take your
                        projects to the next level. Pair them with powerful open
                        source libraries like <a
            ...
            <div
                ...
                <div
                    class="text-center text-sm text-zinc-500 sm:text-left space-x-2">
